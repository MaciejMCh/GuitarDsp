Pod::Spec.new do |spec|
  ...
  spec.ios.source_files = 'GuitarDsp/{Board,Processor,AudioInterface,SamplingSettings,Effect,Sample,FrequencyDomainProcessing,Freeverb,Allpass,Comb,denormals,PhaserEffect}.{h,m}'
